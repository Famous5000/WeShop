...
\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
                ...
                For1:CheckBox( "Disable Ammo Cap Restriction", "wblmoney_noammocaprestriction")
                For1:ControlHelp("If enabled, it will not restrict the weapon from getting more ammo than the set max ammo (by any means)" )
                For1:CheckBox( "Disable Ammo Cap when buying", "wblmoney_noammocaponbuy")
                For1:ControlHelp("If enabled, it will not restrict the weapon from buying more ammo than the set max ammo (can still scavenge ammo to get more)" )
